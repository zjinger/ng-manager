...
export const Events = {
    ...
    TASK_ANALYZE_STARTED: TaskEvents.TASK_ANALYZE_STARTED,
    TASK_ANALYZE_FINISHED: TaskEvents.TASK_ANALYZE_FINISHED,
    TASK_ANALYZE_FAILED: TaskEvents.TASK_ANALYZE_FAILED,
    TASK_RUNTIME_UPDATED: TaskEvents.TASK_RUNTIME_UPDATED,
