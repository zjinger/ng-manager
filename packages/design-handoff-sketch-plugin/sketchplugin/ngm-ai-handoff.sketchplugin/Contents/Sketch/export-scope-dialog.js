...
function buildAccessoryView(entries, checkboxFrames) {
    var scrollView = NSScrollView.alloc().initWithFrame(nsRect(0, 0, DIALOG_WIDTH, DIALOG_HEIGHT));
    ...
    var documentView = NSView.alloc().initWithFrame(nsRect(0, 0, DIALOG_WIDTH - 2, documentHeight));
