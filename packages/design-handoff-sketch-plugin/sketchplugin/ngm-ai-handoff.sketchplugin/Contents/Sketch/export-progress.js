...
function createProgressWindow(title) {
    try {
        var window = NSWindow.alloc().initWithContentRect_styleMask_backing_defer(nsRect(0, 0, WINDOW_WIDTH, WINDOW_HEIGHT), NSTitledWindowMask, NSBackingStoreBuffered, false);
