...
export const createUserSchema = z.object({
  ...
  organizationTitleCode: z.string().trim().optional(),
  defaultProjectTitleCode: z.string().trim().optional(),
...
export const updateUserSchema = z.object({
  ...
  organizationTitleCode: z.string().trim().nullable().optional(),
  defaultProjectTitleCode: z.string().trim().nullable().optional(),
