...
export type SurveyQuestionType = "text" | "textarea" | "single_choice" | "multi_choice" | "rating";
...
export interface ListSurveySubmissionsQuery {
  page?: number;
  pageSize?: number;
  keyword?: string;
}

export interface CreateSurveySubmissionInput {
  contact?: string;
  answers: Array<{
    questionId: string;
    value?: unknown;
