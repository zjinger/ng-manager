...
export type ApprovalStageType =
  ...
  | "cashier"
  | "special_authorizer";
export type ApprovalResolverType =
  | "direct_manager"
  | "department_manager"
  | "department_chain"
  | "system_role";
...
export interface CreateApprovalTemplateStageInput {
  stageCode: string;
  stageName: string;
  stageType: ApprovalStageType;
  resolverType: ApprovalResolverType;
...
export interface CreateApprovalTemplateInput {
  ...
  description?: string | null;
  status?: ApprovalTemplateStatus;
  stages: CreateApprovalTemplateStageInput[];
}
...
export type ApprovalTemplateListResult = PageResult<ApprovalTemplateEntity>;
