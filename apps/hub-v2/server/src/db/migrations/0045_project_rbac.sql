...
VALUES
  ('sperm_project_create', 'project.create', '创建项目', 'project', '项目管理', 'project', '项目管理', '允许创建项目。', 10, datetime('now'), datetime('now')),
  ('sperm_admin_projects_manage', 'admin.projects.manage', '管理项目', 'project', '项目管理', 'project', '项目管理', '用于项目治理管理能力判定。', 15, datetime('now'), datetime('now')),
...
WHERE code IN ('project.create', 'admin.projects.manage', 'project.read.all', 'project.manage.all', 'project.archive', 'project.owner.transfer');
...
FROM system_permissions
WHERE code IN ('project.create', 'admin.projects.manage');
