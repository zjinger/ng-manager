...
import { FinancingDashboardPanelComponent } from '../../components/financing-dashboard-panel/financing-dashboard-panel';
import {
  FinancingMyTodosCardComponent,
  TodoItem,
} from '../../components/financing-my-todos-card/financing-my-todos-card';
import { FinancingQuickEntryComponent } from '../../components/financing-quick-entry/financing-quick-entry';
import { FinancingAnnouncementsComponent } from '../../components/financing-announcements/financing-announcements';
import { Router } from '@angular/router';
@Component({
  selector: 'app-financing-dashboard-page',
  standalone: true,
  imports: [
    CommonModule,
    FinancingDashboardPanelComponent,
    FinancingMyTodosCardComponent,
    NzButtonModule,
    PageHeaderComponent,
    ...
    FinancingAnnouncementsComponent,
  ],
  templateUrl: './financing-dashboard-page.component.html',
  styleUrls: ['./financing-dashboard-page.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FinancingDashboardPageComponent {
