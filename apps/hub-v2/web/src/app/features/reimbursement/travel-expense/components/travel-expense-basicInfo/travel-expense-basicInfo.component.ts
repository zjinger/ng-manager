        ...
        <nz-form-item style="display: block;" [class.has-error]="isDateInvalid()">
          ...
          <div class="date-time-group">
            ...
            <nz-select
              style="width: 100px"
              nzPlaceHolder="上/下午"
              name="travelStartHalf"
              [ngModel]="value().travelStartHalf"
              (ngModelChange)="updateField('travelStartHalf', $event)"
            >
        ...
        <nz-form-item style="display: block;" [class.has-error]="isDateInvalid()">
          ...
          <div class="date-time-group">
            ...
            <nz-select
              ...
              nzPlaceHolder="上/下午"
              name="travelEndHalf"
              [ngModel]="value().travelEndHalf"
              (ngModelChange)="updateField('travelEndHalf', $event)"
            >
              @for (item of timeOptions; track item.value) {
                <nz-option [nzLabel]="item.label" [nzValue]="item.value" />
              }
...
export class TravelExpenseBasicInfoComponent {
  ...
  updateTravelStartDate(date: Date | null): void {
    ...
    this.updateField('travelStartDate', this.formatDate(date));
  }

  updateTravelEndDate(date: Date | null): void {
    this.travelEndDateValue.set(date);
    this.updateField('travelEndDate', this.formatDate(date));
  }
