...
@Component({
  ...
  standalone: true,
  imports: [NzButtonModule, NzIconModule, PriorityBadgeComponent, StatusBadgeComponent, NzPopconfirmModule, NzTooltipModule],
  template: `
...
export class IssueDetailHeaderComponent {
  readonly flowSteps = [
