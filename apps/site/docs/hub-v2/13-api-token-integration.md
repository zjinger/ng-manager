...
| Docs 写入 | 创建、编辑、发布 | `hub_v2_docs_create`、`hub_v2_docs_update`、`hub_v2_docs_publish` | 已暴露 |
| Issue 读取 | 列表、详情、日志、评论、协作人、附件、协作分支、raw 读取 | `hub_v2_issues_list`、`hub_v2_issues_get`、`hub_v2_issues_logs_list`、`hub_v2_issues_comments_list`、`hub_v2_issues_participants_list`、`hub_v2_issues_attachments_list`、`hub_v2_issues_branches_list`、`hub_v2_issues_attachment_raw_get`、`hub_v2_issues_upload_raw_get` | 已暴露 |
| Issue 写入 | 创建、编辑、评论、指派、认领、流转 | `hub_v2_issues_create`、`hub_v2_issues_update`、`hub_v2_issues_comment`、`hub_v2_issues_assign`、`hub_v2_issues_claim`、`hub_v2_issues_start`、`hub_v2_issues_wait_update`、`hub_v2_issues_resolve`、`hub_v2_issues_verify`、`hub_v2_issues_reopen`、`hub_v2_issues_close` | 已暴露 |
...
Issue 协作分支仍使用 `issue:branch:write` scope。MCP 对应 `hub_v2_issues_branch_create`、`hub_v2_issues_branch_start_mine`、`hub_v2_issues_branch_start`、`hub_v2_issues_branch_complete`。
