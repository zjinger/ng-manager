...
> 来源：由 `apps/hub-v2/server/docs/reimbursement-api-contract.md` 迁入站点文档。本文作为报销模块正式联调契约，配合 [23 财务与审批总览](/hub-v2/23-finance-approval-overview) 与 [27 报销模块 API 示例请求](/hub-v2/27-reimbursement-api-examples) 阅读。
