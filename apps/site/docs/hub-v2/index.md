...
- 通知与上传：读 [18 通知机制](/hub-v2/18-notification-mechanism)、[14 WS 实时通知机制](/hub-v2/14-ws-realtime-notification)、[19 上传生命周期与清理策略](/hub-v2/19-upload-lifecycle-and-cleanup)。
