...
import {
  ...
  TabContextMenuEvent,
} from './components/request-tabs-bar/request-tabs-bar.component';
        ...
        <div class="content">
          ...
          @if (store.activeRequest()) {
            <div class="editor-area">
              <nz-splitter nzLayout="vertical" (nzResize)="splitterResize($event)">
                <nz-splitter-panel [nzMin]="160" [nzSize]="splitterTopHeigth()">
                  <app-request-editor
                    ...
                    (optTabChange)="optTabChange()"
                  />
                </nz-splitter-panel>
                <nz-splitter-panel [nzMin]="112">
                  <app-response-viewer
                    [sending]="store.activeSending()"
            ...
            <nz-empty [nzNotFoundContent]="contentTpl" [nzNotFoundFooter]="footerTpl"> </nz-empty>
          }
...
export class ApiClientComponent {
  ...
  splitterTopHeigth = signal<string | number>(400);
  ...
  optTabChange() {
    this.splitterTopHeigth.set(400);
  }

  splitterResize(number: number[]) {
    this.splitterTopHeigth.set(number[0]);
  }
}
